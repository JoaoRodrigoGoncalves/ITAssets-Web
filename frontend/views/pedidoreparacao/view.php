...
$this->title = "Pedido de Reparação Nº".$model->id;
...
<div class="pedido-reparacao-view">
    <div class="container flex-grow-1 container-p-y mt-3">
        <div class="card">
            ...
            <?php if($model->status == PedidoReparacao::STATUS_ABERTO): ?>
                <div class="card-footer">
                    <?= Html::a('Cancelar', ['pedidoreparacao/cancelar', 'id' => $model->id], ['class' => 'btn btn-danger float-right', 'data-method' => 'post']) ?>
                </div>
            <?php endif; ?>
        </div>
